...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "cobralibero-FHD.mod/skin.xml" or "PLi-HD/skin.xml"  # SD hardware is no longer supported by the default skin.
